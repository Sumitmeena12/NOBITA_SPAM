...
HELP_STRING = f"˹ℕ𝕆𝔹𝕀𝕋𝔸 ꭙ 𝕊ℙ𝔸𝕄🫧˼ 𝙃𝙚𝙡𝙥 𝙈𝙚𝙣𝙪 ★\n\n» **𝐂𝐋𝐈𝐂𝐊 𝐎𝐍 𝐁𝐔𝐓𝐓𝐎𝐍 𝐅𝐎𝐑 𝐇𝐄𝐋𝐏**\n» **𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥: ˹@NOBITA_H ˼🫧**"
...
HELP_BUTTON = [
    ...
    [
      Button.url("★𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥★", "https://t.me/+ufHtwmva_KY5YTRl"),
    ...
    if event.sender_id in SUDO_USERS:
        try:
          await event.client.send_file(event.chat_id,
              "https://telegra.ph/file/256ec2d2a73ca671b521b.jpg",
              caption=HELP_STRING,
              buttons=HELP_BUTTON
              )
    ...
    if event.query.user_id in SUDO_USERS:    
        await event.edit(
            ...
            buttons=[
              ...
              [
                Button.url("★𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥★", "https://t.me/https://t.me/+ufHtwmva_KY5YTRl"),
                Button.url("★𝗦𝗨𝗣𝗣𝗢𝗥𝗧★", "https://t.me/NOBITA_H")
              ]
            ]
          )
    else:
        await event.answer("★𝐏𝐋𝐄𝐀𝐒𝐄 𝐉𝐎𝐈𝐍 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐆𝐑𝐎𝐔𝐏 𝐀𝐍𝐃 𝐓𝐀𝐆 @admin★" , cache_time=0, alert=True)
